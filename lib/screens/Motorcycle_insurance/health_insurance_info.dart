...
class HealthInsuranceForm extends StatelessWidget {
  static const route = '/HealthInsuranceForm';
  const HealthInsuranceForm({Key? key}) : super(key: key);
              ...
              RichText(
                  ...
                  text: TextSpan(
                      style: TextStyle(
                          ...
                          letterSpacing: -0.3),
                      children: [
                        TextSpan(text: "Health Insurance  "),
                        TextSpan(
                          text: "",
                          style: TextStyle(
