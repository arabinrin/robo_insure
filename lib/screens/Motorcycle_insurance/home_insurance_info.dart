...
class HomeInsuranceForm extends StatelessWidget {
  static const route = '/HomeInsuranceForm';
  const HomeInsuranceForm({Key? key}) : super(key: key);
              ...
              RichText(
                  ...
                  text: TextSpan(
                      style: TextStyle(
                          ...
                          letterSpacing: -0.3),
                      children: [
                        TextSpan(text: "Home Insurance  \n"),
                        TextSpan(
                          text: "Fire & Special Perils",
                          style: TextStyle(
