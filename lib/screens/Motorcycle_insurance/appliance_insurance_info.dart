...
class ApplianceInsuranceForm extends StatelessWidget {
  static const route = '/ApplianceInsuranceForm';
  const ApplianceInsuranceForm({Key? key}) : super(key: key);
              ...
              RichText(
                  ...
                  text: TextSpan(
                      style: TextStyle(
                          ...
                          letterSpacing: -0.3),
                      children: [
                        TextSpan(text: "Appliance Insurance   "),
                        TextSpan(
                          text: "",
                          style: TextStyle(
