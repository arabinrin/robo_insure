...
class MotorcycleInsuranceForm extends StatelessWidget {
  static const route = '/MotorcycleInsuranceForm';
  const MotorcycleInsuranceForm({Key? key}) : super(key: key);
              ...
              RichText(
                  ...
                  text: TextSpan(
                      style: TextStyle(
                          ...
                          letterSpacing: -0.3),
                      children: [
                        TextSpan(text: "Motorcycle Insurance "),
                        TextSpan(
                          text: "",
                          style: TextStyle(
