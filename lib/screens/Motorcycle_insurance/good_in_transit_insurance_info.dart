...
class GoodsInTransitInsuranceForm extends StatelessWidget {
  static const route = '/GoodsInTransitInsuranceForm';
  const GoodsInTransitInsuranceForm({Key? key}) : super(key: key);
              ...
              RichText(
                  ...
                  text: TextSpan(
                      style: TextStyle(
                          ...
                          letterSpacing: -0.3),
                      children: [
                        TextSpan(text: "Goods-in-Transit Insurance  "),
                        TextSpan(
                          text: "",
                          style: TextStyle(
