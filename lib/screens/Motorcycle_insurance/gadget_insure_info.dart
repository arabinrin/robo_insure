...
class GadgetInsuranceForm extends StatelessWidget {
  static const route = '/GadgetInsuranceForm';
  const GadgetInsuranceForm({Key? key}) : super(key: key);
              ...
              RichText(
                  ...
                  text: TextSpan(
                      style: TextStyle(
                          ...
                          letterSpacing: -0.3),
                      children: [
                        TextSpan(text: "Gadgets Insurance  "),
                        TextSpan(
                          text: "",
                          style: TextStyle(
