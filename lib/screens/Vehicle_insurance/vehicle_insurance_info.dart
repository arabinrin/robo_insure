...
class VehicleInsuranceForm extends StatelessWidget {
  static const route = '/VehicleInsuranceForm';
  const VehicleInsuranceForm({Key? key}) : super(key: key);
...
class BenefitModal extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Padding(
      padding: EdgeInsets.symmetric(horizontal: 33.r, vertical: 30.r),
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          RichText(
          ...
          RichText(
              ...
              text: TextSpan(
                  style: TextStyle(
                      ...
                      letterSpacing: -0.3),
                  children: [
                    TextSpan(text: "Extensions on The Policy  " + " "),
                    TextSpan(
                      text: " ",
                      style: TextStyle(
